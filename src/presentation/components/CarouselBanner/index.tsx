    ...
    return (
        <Fragment>
            <Carousel
                ...
                nextIcon={<img src={icons.arrow} height={10} width={6} className="carousel-banner-next" />}
                prevIcon={<img src={icons.arrow} height={10} width={6} className="carousel-banner-prev" />}
