        ...
        <div style={styles.contentProfil}>
          {isCV && (
            <button onClick={handleToogle}>
              <ButtonAside
                title={activeString.DETAIL_PROFIL.STATUS}
                icon={icons.statut}
                toogle={true}
              />
              {toogle && (
          ...
          {isCV && (
            <ButtonAside
              title={activeString.DETAIL_PROFIL.MON_CV}
              onClick={handleRedirectionCv}
              icon={icons.cv}
            />
          )}
          {hasMyVideo && (
            <ButtonAside
              ...
              onClick={() => {
                navigate('/ResumeVideoScreen', { state: { isShow: true } });
              }}
              icon={icons.video}
            />
          )}
          <ButtonAside
            ...
            onClick={() => {
              navigate('/CandidatProfilBackupScreen');
            }}
            icon={icons.ads}
          />
          <ButtonAside
          ...
          />
          <ButtonAside
            title={activeString.DETAIL_PROFIL.PETITES_ANNONCES}
            onClick={() => {
      ...
      <div
        style={
          isMobile
            ...
            : [styles.container, styles.containerMore]
        }
      >
