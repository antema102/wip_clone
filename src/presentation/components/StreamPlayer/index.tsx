...
const StreamPlayer = ({ width, height, poster, isStyled = true, id = uuid(), isExample, candidatId, viewOnly }: videoPlayerProps) => {
    ...
    const userId = candidatId ? candidatId : user?.id;
    ...
    return (
        <>
            <video width={width ? width : '100%'} height={height ? height : 300} id={id} controls autoPlay={true} poster={poster ? poster : 'https://i.picsum.photos/id/866/1600/900.jpg'} style={isStyled ? styles.videoShape : null}>
