      ...
      <div style={styles.header}>
        <div style={styles.avatarContainer}>
          <img
            ...
            src={
              userAvatar ||
              (images.avatar_6 as import('react-native').ImageSourcePropType)
            }
          />
          {isChangeable && (
            <Fragment>
              <button style={styles.editIcon} onClick={handleEditClick}>
                {/* You can replace this with your edit icon */}
                <img
                  src={
                    icons.camera as import('react-native').ImageSourcePropType
                  }
