...
export const ValidateCompany = (props: any) => {
  ...
  const noError = (errors: Record<string, any>) =>
    Object.values(errors).every((error) => !error);

  useEffect(() => {
    if (!errors.compteur) {
      setErrors((previousState: typeof errors) => ({
        ...previousState,
        compteur: true,
      }));
    } else {
            ...
            <div className="validate__formsText">
              ...
              <div className="validate__form">
                <div className="validate__input">
                  <input
                    type="text"
                    placeholder={TitleLabels.ValidateCompany.representant}
                    maxLength={50}
                ...
                <div className="validate__input">
                  <input
                    className={`${errorAnnee ? 'error ' : ' '}`}
                    type="number"
                    name="yearOfCreation"
                    value={values.yearOfCreation}
                    placeholder={TitleLabels.ValidateCompany.annee}
                    onChange={handleChange}
                    maxLength={4}
                    required
                  />
                  ...
                  {errorAnnee ? (
                    <span style={{ color: COLORS.red_color, fontSize: 10 }}>
                      {error}
                    </span>
                  ) : null}
                </div>
              ...
              <div className="validate__form">
                ...
                <div className="validate__input">
                  <input
                    className={`${errorHeadQuarter ? 'error' : ' '}`}
                    type="text"
                    name="headQuarter"
                    placeholder={TitleLabels.ValidateCompany.headQuarter}
              ...
              <div className="validate__input">
                <input
                  className={`${errorUrl ? 'error' : ' '}`}
                  type="text"
                  name="url"
                  placeholder={TitleLabels.ValidateCompany.url}
                  value={values.url}
                  maxLength={50}
                  onChange={handleChange}
                  required
              ...
              <div className="validate__files">
                <label htmlFor="fileUpload">
                  ...
                  <span style={{ textAlign: 'center' }}>
                    Ajoutez une copie de votre NIF/STAT pour valider votre
                    compte entreprise. (*pdf ,png,jpg,webp)
                  </span>
                </label>
                <input
                  type="file"
              ...
              <div className="validate__checkbox">
                ...
                />
                <p>
                  {TEXT_INFORMATIONS.ENTERPRISE_CHECKBOX}
                  <a
                    href="https://www.wipwork.com/terms"
                    target="_blank"
                    rel="noreferrer"
                  >
              ...
              <div className="validate__btn">
                ...
                <button
                  className="validate__btn--orange"
                  onClick={() => {
