...
export const EnterpriseAdvertisingScreen = (props: any) => {
  ...
  const { getAdverstisementsByOwnerId, getCostsUser, getPostsByOwnerId } =
    UserSA();
  ...
  const renderItemTemplate = (item: any) => (
    <Fragment>
      <Advertising
        data={item}
        navigation={navigate}
        isAd={user?.role === activeString.ROLEACCOUNT.company}
      />
    </Fragment>
  );
          ...
          <div style={[styles.containers]}>
            ...
            {refreshing || loadingMobile ? (
              ...
              <>
                ...
                <FixedButtonCircle
                  handleNavigate={createAnnouce}
                  activeTooltip={true}
                  tooltipValue={
                    user?.role === activeString.ROLEACCOUNT.company
                      ? ' Création publicité'
                      : ' Ajouter une petits annonce'
                  }
                  styles={
                    isMobile
                      ? {
