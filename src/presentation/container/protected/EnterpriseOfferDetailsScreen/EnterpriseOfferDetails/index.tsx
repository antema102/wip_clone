      ...
      <div style={styles.container}>
        <div style={styles.containers}>
            ...
            <div style={isMobile ? { flex: 1 } : styles.contentOffer}>
              <div>
                {candidat ? (
                  <div
                    style={
                      isMobile ? styles.headerOfferMobile : styles.headerOffer
                    }
                  >
                  ...
                  <div>
                    <CustomButton
                      onClick={() => {
                        navigate('EnterpriseOffreSheetApplyScreen', {
              ...
              >
                <ViewDetailsCandidat
                  ...
                  value={
                    formation ? formation?.place || '' : offerDetail?.lieu || ''
                  }
                />
                <ViewDetailsCandidat
                  label={
                    formation
                      ? activeString.ENTERPRISE_OFFER.THEME
                      : activeString.ENTERPRISE_OFFER.TRAVAIL
                  }
                  value={
                    formation
                      ? formation?.theme || ' '
                ...
                <ViewDetailsCandidat
                  label={
                    formation
                      ? activeString.ENTERPRISE_OFFER.PAYANT
                      : activeString.ENTERPRISE_OFFER.CONTRACT
                  }
                  value={
                    formation
                      ? formation?.isPayante
                ...
                <ViewDetailsCandidat
                  label={
                    formation
                      ? activeString.ENTERPRISE_OFFER.PRIX
                      : activeString.ENTERPRISE_OFFER.PROFIL
                  }
                  value={
                    formation
                      ? `${thousandSeparator(formation?.prix, '.') || 0} Ar`
                      : offerDetail?.profil || ''
                  }
                />
                {formation ? (
                ...
                <ViewDetailsCandidat
                  label={
                    formation
                      ? activeString.ENTERPRISE_OFFER.TELEPHONE
                      : activeString.ENTERPRISE_OFFER.EXPERIENCE
                  }
                  value={
                    formation ? formation?.phone : offerDetail?.experience || ''
                  }
                />
                <ViewDetailsCandidat
                  label={
                    formation
                      ? activeString.ENTERPRISE_OFFER.EMAIL
                      : activeString.ENTERPRISE_OFFER.SALAIRE_BRUTE
                  }
          ...
          >
            ...
            <div
              style={{
                ...(isMobile ? '' : styles.candidateExpContainer),
                ...(isFormation && { marginBottom: 34 }),
              }}
            >
              <div style={styles.candidateExpContent}>
                <span style={styles.candidateExpTitle}>
                  {activeString.ENTERPRISE_OFFER.DESCRIPTION}
                </span>
              </div>
            ...
            {!isFormation && (
              <div
                style={[styles.candidateExpContainer, { paddingBottom: 26 }]}
              >
                <div style={styles.candidateExpContent}>
                  <span style={styles.candidateExpTitle}>
                    {activeString.ENTERPRISE_OFFER.YOUR_TASK}
                  </span>
                </div>
                <span style={styles.txtDetails}>
                  {offerDetail?.taches || ''}
          ...
          >
            <span style={styles.titleh2}>
              {activeString.ENTERPRISE_OFFER.ABOUT_COMPANY}
            </span>
          </div>
          ...
          {offerList.length === 0 || isFormation ? (
            <div style={{ marginBottom: 0 }} />
          ) : (
            <div style={styles.nextContainer}>
              <div style={styles.titleh2Container}>
                <span style={styles.titleh2}>
                  {activeString.ENTERPRISE_OFFER.SIMILAR_OFFERS}
                </span>
              </div>
              <div
                style={{
              ...
              >
                <FlatOffer offerList={offerList} showDetails={showDetails} />
              </div>
            </div>
          )}
        </div>
