  ...
  const handleDelete = () => {
    ...
    setMessage(
      `Voulez-vous vraiment supprimer ${
        isFormation ? 'cette formation' : 'cette offre'
      }`
    );
  };
            ...
            <div style={{ width: '100%' }}>
              <div style={styles.vtitle}>
                <div style={{ paddingHorizontal: 26 }}>
                  <button
                    style={[styles.buttonBack, { marginTop: 24 }]}
                    onClick={handleBack}
                  >
                    <img
                  ...
                  <div style={{ gap: 16 }}>
                    ...
                    >
                      <div>
                        <img
                          height={100}
                          width={100}
                          src={avatar || images.avatar_1}
                          style={{ objectFit: 'cover' }}
                        />
                      </div>
                      <div style={{ gap: 4 }}>
                        <span style={{ fontSize: 20, fontWeight: '600' }}>
                          {isFormation ? offerDetail.title : offerDetail.name}
                        </span>
                        <div style={{ flexDirection: 'row', gap: 4 }}>
                          ...
                          >
                            • {offerDetail?.place || offerDetail?.lieu || ''}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <ViewDetailsCandidat
                        label={
                          isFormation
                            ...
                            : `${activeString.ENTERPRISE_OFFER.SALAIRE_BRUTE} (Ariary)`
                        }
                        value={
                          isFormation
                            ? offerDetail?.email
                      ...
                      <ViewDetailsCandidat
                        ...
                        value={format(offerDetail?.createdAt, 'dd MMMM yyyy', {
                          locale: fr,
                        })}
                      />
                    </div>
                  ...
                  <div style={{ marginVertical: 16 }}>
                    ...
                    >
                      ...
                      >
                        <div>
                          <img src={icons.statistique} height={14} width={14} />{' '}
                        </div>
                      ...
                      <div style={{ paddingTop: 14, gap: 16 }}>
                        <span style={{ fontWeight: 700, fontSize: 20 }}>
                          {viewsCount} {activeString.ENTERPRISE_OFFER.VIEW}{' '}
                        </span>
                        <span>
                          {
                            activeString.ENTERPRISE_OFFER
                              .NUMBER_OF_CANDIDATES_VIEWED_YOUR_OFFER
                          }{' '}
                          {isFormation ? 'formation ' : 'offre '}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  {!isFormation ? (
                    <div style={{ top: 20, marginBottom: 24 }}>
                      <CustomButton
                        onClick={() => {
                          navigate('/EnterpriseOfferSheetApplyScreen', {
                ...
                {descriptionError && (
                  <span style={{ color: COLORS.red_color, marginLeft: 25 }}>
                    {ERROR.EMPTY_FIELD}
                  </span>
                )}
              ...
              {!isFormation && (
                <div style={{ paddingVertical: 20, marginHorizontal: 25 }}>
                  <CustomButtons
                    ...
                    title={
                      boostStatus
                        ? activeString.ENTERPRISE_OFFER.BOOSTED_OFFER
                        : activeString.ENTERPRISE_OFFER.BOOST_THIS_OFFER
                    }
                    _style={{
              ...
              {isBoosted ? (
                <MiniLoader CustomStyle={{ position: 'fixed' }} />
              ) : (
                <Popup
