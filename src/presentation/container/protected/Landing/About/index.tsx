    ...
    <div className="about" id="about">
      ...
      <div className="about__content">
        <div className="about__text">
          <p>
            Le marché de l'emploi à Madagascar est en déclin. En 2022, plus de
            2.000.000 de jeunes Malgaches étaient sans emplois non pas en raison
            d'un manque de compétences, mais par inadéquation entre l'offre et
            la demande.
          </p>
          <p>
            WIPwork a pour mission de résoudre ce déséquilibre en mettant en
            relation les talents et recruteurs grâce à un système de matching
            avancé.
          </p>
          <p>
          ...
          <p>
            Notre vision, simplifié le marché du travail en connectant les
            meilleurs talents aux offres les plus appropriés et visse versa.
          </p>
        </div>
        <div className="about__imageGroup">
          <div
            className="about__item active"
            onClick={() => {
          ...
          {data.map((image, index) => (
            <div
              ...
              onClick={() => {
                openPopup(image.images);
              }}
            >
              <img src={image.images} loading="lazy" alt={image.alt} />
              {selectedImage !== image.images && <div className="overlay" />}
            </div>
          ))}
        </div>
      </div>
