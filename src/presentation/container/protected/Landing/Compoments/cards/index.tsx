  ...
  const data = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          textContent:
            'Tu reçois des notifications régulières des nouvelles offres correspondant à tes critères de recherche, assurant une veille constante des opportunités disponibles.',
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          textContent:
            "Créez et publiez rapidement des offres d'emploi ciblées, touchant un large vivier de candidats qualifiés via la plateforme.",
        },
        {
          ...
          textContent:
            "La recherche est affinée par des filtres avancés pour trouver les talents correspondant à vos critères spécifiques, comme le secteur d'activité, l'expérience,ou la localisation des talents.",
        },
        {
          url: images.puzzle,
          subText: (
            <>
              Matching avancé et <br />
              triage de candidatures
            </>
          ),
          textContent:
            'Grâce au système de matching, vous accédez instantanément aux meilleurs profils avec un taux de compatibilité élevé, facilitant votre processus de sélection.',
        },
        {
          ...
          textContent:
            'Attirez les meilleurs profils ou, tout simplement, faites connaître  votre entreprise aux autres  entreprises partenaires de  WipWork. Lancez des campagnes publicitaires globales ou ciblées',
        },
      ],
    },
  ];
