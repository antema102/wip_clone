      ...
      <div className='container'>
        ...
        <div className='footer__content '>
          ...
          <ul className='footer__item'>
            ...
            <li>
              <a onClick={() => scrollToSection('offre')}>Dernières opportunités</a>
            </li>
            <li>
              {
                SignedIn ?
          ...
          <ul className='footer__item'>
            <li>
              <div>
                <p>Adresse</p>
                <p>Antananarivo, Madagascar
                  <br />
                  Village des jeux Akorondrano , box  E3</p>
              ...
              <div className='footer__application'>
                ...
                <div>
                  <Link to="https://play.google.com/store/apps/details?id=com.wipwork&hl=fr&pli=1" target='_blank'>
                    <img src={images.android} width={143} height={47} loading='lazy' />
                  </Link>
                  <Link to="https://apps.apple.com/fr/app/wipwork/id6443874679" target='_blank'>
                    <img src={images.apple} width={143} height={47} loading='lazy' />
                  </Link>
                </div>
              </div>
            </li>
            ...
            <ul className='footer__cookie'>
              <p className='margin-bottom-10' style={{ textTransform: 'uppercase' }}>Mention légale et Politique</p>
              <li> <Link to="/terms" >CGU</Link > </li>
              <li> <Link to="/terms" > Politique de confidentialité</Link ></li>
              <li><Link to="/terms">Politique de cookies</Link ></li>
            </ul>
          </ul>
        </div>
        <div className="footer__resauxSocial">
          <Link to="https://www.facebook.com/profile.php?id=100092615205995">
            <img src={icons.facebookBlack} alt="facebook" height={16}
              width={16} style={{ objectFit: 'contain' }} loading='lazy' />
          </Link>
          <Link to="https://www.linkedin.com/company/wipwork/">
            <img src={icons.linkedinBlack} alt='facebook' height={16}
              width={16} style={{ objectFit: 'contain' }} loading='lazy' />
          </Link>
        </div>
