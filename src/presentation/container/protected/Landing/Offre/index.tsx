...
const offreData = [
  {
    ...
    description: (
      <>
        <p>
          Nous recherchons un(e) comptable pour renforcer notre équipe. Vos
          missions incluront :
        </p>
        <ul style={{ listStyleType: 'initial', paddingTop: 5 }}>
          <li style={{ marginLeft: 25 }}>
            Gestion des comptes et opérations financières
          </li>
          <li style={{ marginLeft: 25 }}>
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          {' '}
          Vous êtes passionné(e) par le développement web et la création
          d'expériences utilisateur innovantes ?
        </p>
        <ul style={{ listStyleType: 'initial', paddingTop: 5 }}>
          <li style={{ marginLeft: 25 }}>
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Vous avez le flair pour les tendances et savez engager les communautés
          comme personne ?
        </p>
        <ul style={{ listStyleType: 'initial', paddingTop: 5 }}>
          <li style={{ marginLeft: 25 }}>
            Création de contenus originaux et captivants.
          </li>
          <li style={{ marginLeft: 25 }}>
            Gestion des interactions et développements.
          </li>
