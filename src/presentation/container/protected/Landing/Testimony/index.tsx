...
const Testimony: React.FC = () => {
    const testimonies: TestimonyProps[] = [
        {
            headerText: "WIPwork a transformé notre recrutement en nous offrant des candidats parfaitement qualifiés, grâce à son algorithme de matching ultra-précis",
            userImage: images.logoCarnivore,
            userName: "LE CARNIVORE",
            userWork: "Lounge Bar Restaurant"
        },
        {
            headerText: "Cela  nous fait gagner un temps précieux dans le recrutement. Un outil incontournable !!",
            userImage: images.logoAgroTech,
            userName: "AGRO TECH",
            userWork: "Distributeur- Import et Export"
        },
        {
            headerText: "La plateforme combine une interface facile à utiliser avec des résultats de recrutement rapides et précis. Impressionnante 👌",
            userImage: images.LogoLaHalle,
            userName: "GOOD VIB’S",
            userWork: "Boutique de vêtements, chaussures et accessoires."
        },
        {
            headerText: "Nous avons recruté des talents rares correspondant exactement à nos critères, avec une plateforme intuitive et des résultats toujours fiables",
