    ...
    <div style={styles.container}>
      ...
      <div>
        ...
        <div style={[styles.containers]}>
          ...
          <div
            style={[globalStyle.pageContainerPresentation, styles.contentPage]}
          >
            <TitleRefont
              title={
                state?.isShow
                  ? activeString.RESUME_VIDEO.WELCOMING
                  : activeString.RESUME_VIDEO.PRESENTATION
              }
              _customStyle={{ backgroundColor: COLORS.blue_back }}
            />
            <div style={styles.contentAdvice}>
              <span style={styles.resumeTitle}>
                {activeString.RESUME_VIDEO.ADVICE}
              </span>
            ...
            <div style={{ marginTop: 20 }}>
              <div style={{ paddingVertical: 20 }}>
                <FileUploader
                  ...
                  accept="video/*"
                  fileName={activeString.RESUME_VIDEO.IMPORT}
                  icon={icons.download}
                />
              </div>
            </div>
            ...
            <div style={{ marginTop: 20 }}>
              {isVideo && (
                <div style={globalStyle.btnContainer}>
                  <CustomButtons
                    onClick={async () => {
                      await displayVideoCandidat();
                    }}
                    title={activeString.RESUME_VIDEO.DISPLAY}
                    _style={[globalStyle.buttonHomeDisplay]}
                    color="red"
                    icon={icons.display}
        ...
        <CustomModal
          title={
            isSpecial
              ...
              : `${activeString.RESUME_VIDEO.IMPORT}`
          }
          visible={visible}
          setVisible={setVisible}
          content={<DisplayVideo isExample={isExample} />}
        />
      ) : null}
    </div>
  );
