...
export const useInscription = () => {
  ...
  return {
    setRegisterStatus: (payload) =>
      dispatch({ payload, type: InscriptionActionType.setIsRegister }),
    setRegisterStatusInitiate: () =>
      dispatch({
        payload: initialInscriptionState.credentials,
        type: InscriptionActionType.setIsRegisterInitiate,
      }),
    updateCredentials: (payload) =>
      dispatch({ payload, type: InscriptionActionType.updateCredentials }),
